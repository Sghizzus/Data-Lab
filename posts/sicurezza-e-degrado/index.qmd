...
data |> 
  group_by(provincia_codice) |> 
  nest() |> 
  future_pwalk(\(provincia_codice, data) {
    ...
    write_dataset(fit, str_c("cittadini-residenti-distribution/provincia_codice=", provincia_codice, "/part-0"), format = "parquet") 
...
fit |> 
  group_by(provincia) |> 
  write_dataset("cittadini-residenti-distribution", format = "parquet")
```
