...
>>>>>>> 2cf6a2364f820c20478e702568ddb8571824b22d
...
=======
      probs <- space |> 
        mutate(
          prob = map2_dbl(x, y, ~dmultinom(.x, M, p, log = TRUE) + dmultinom(.y, N, q, log = TRUE)),
          prob = prob - max(prob),
          prob = exp(prob)
        )
      
      space_row_number <- sample(1:nrow(probs), 1, prob = probs$prob)
      
      x <- probs$x[[space_row_number]]
>>>>>>> 2cf6a2364f820c20478e702568ddb8571824b22d
